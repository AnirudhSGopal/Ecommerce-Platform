...
const MyOrders = () => {
    ...
    const fetchMyOrders = async () => {
        try {
            ...
            // Handle error silently or display a toast notification
        }
    };
        ...
        <div className='mt-16 pb-16'>
            ...
            {MyOrders.length === 0 ? (
                ...
                MyOrders.map((Order, index) => (
                    <div key={index} className='border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4x1'>
                            ...
                            >
                                <div className='flex items-center mb-4 md:mb-0'>
                                    <div className='bg-primary/10 p-4 rounded-lg'>
                                        <img src={item.product?.images?.[0]} alt="product" className='w-16 h-16' />
                                    </div>
                                    <div className='ml-4'>
